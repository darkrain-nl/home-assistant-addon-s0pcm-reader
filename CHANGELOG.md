...
## [2.3.3] - 2026-01-24
### Added
- **Unified Dependency Automation**: Integrated **Renovate Bot** to replace Dependabot. This enables automated updates for the custom `build.yaml` Home Assistant base images, alongside Python requirements, GitHub Actions, and Docker files.
- **Expanded Tracking**: Added the `tests/` directory to the automated update schedule for both Python and Docker ecosystems.
