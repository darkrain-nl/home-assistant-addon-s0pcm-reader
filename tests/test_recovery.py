...
class TestMQTTMessageParsing:
    ...
    def test_parse_discovery_topic_with_name(self, recoverer):
        ...
        msg.payload = json.dumps({
            'unique_id': 's0pcm_s0pcmreader_1_total',
            'state_topic': 's0pcmreader/Water/total'
        }).encode()
    ...
    def test_parse_discovery_topic_ignores_id_as_name(self, recoverer):
        ...
        msg.payload = json.dumps({
            'unique_id': 's0pcm_s0pcmreader_2_total',
    ...
    def test_parse_discovery_topic_ignores_none(self, recoverer):
        ...
        msg.payload = json.dumps({
            'unique_id': 's0pcm_s0pcmreader_3_total',
            'state_topic': 's0pcmreader/None/total'
        }).encode()
...
class TestRobustStateCleaning:
    ...
    def test_clean_state_with_cubic_meters(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '1234.56 m³'}
        ]
    ...
    def test_clean_state_with_kwh(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '5678.90 kWh'}
        ]
    ...
    def test_clean_state_with_comma_decimal(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '1234,56'}
        ]
    ...
    def test_clean_state_with_thousands_separator(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '1.234.567'}
        ]
    ...
    def test_clean_state_with_mixed_separators(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '1.234,56 m³'}
        ]
    ...
    def test_clean_state_plain_number(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '9876543'}
        ]
    ...
    def test_find_total_with_name_pattern(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_water_meter_total', 'state': '12345'}
        ]
    ...
    def test_find_total_returns_none_for_unavailable(self, recoverer):
        ...
        ha_states = [
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': 'unavailable'}
        ]
...
class TestRecoveryFlow:
    ...
    def test_run_subscribes_to_topics(self, recoverer, mocker):
        ...
        topics = [call[0][0] for call in recoverer.mqttc.subscribe.call_args_list]
    ...
    def test_run_initializes_meters_from_mqtt_data(self, recoverer, mocker):
        ...
        recoverer.recovered_data = {
            '1': {'total': 1000, 'today': 50, 'yesterday': 40, 'pulsecount': 10}
        }
    ...
    def test_run_skips_zero_only_data(self, recoverer, mocker):
        ...
        recoverer.recovered_data = {
            '1': {'total': 0, 'today': 0, 'yesterday': 0, 'pulsecount': 0}
        }
    ...
    def test_run_uses_ha_api_fallback(self, recoverer, mocker):
        ...
        mocker.patch('time.sleep')
        mocker.patch.object(recoverer, 'fetch_all_ha_states', return_value=[
            {'entity_id': 'sensor.s0pcmreader_1_total', 'state': '5000'}
        ])
    ...
    def test_run_merges_name_and_id_data(self, recoverer, mocker):
        ...
        recoverer.recovered_data = {
            '1': {'total': 1000, 'pulsecount': 10},
            'Water': {'today': 50, 'yesterday': 40}
        }
        recoverer.recovered_names = {1: 'Water'}
